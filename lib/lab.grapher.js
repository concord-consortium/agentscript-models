...
define('lab.version',['require'],function (require) {
  return {
    "repo": {
      "branch": "master",
      "commit": {
        "sha":           "864fd29a92eadecbd7ac44aceea6a45aefa24418",
        "short_sha":      "864fd29a",
        "url":            "https://github.com/concord-consortium/lab/commit/864fd29a",
        "author":        "Piotr Janik",
        "email":         "janikpiotrek@gmail.com",
        "date":          "2013-06-11 19:58:12 +0000",
        "short_message": "Make DNA interactives public",
        "message":       "Make DNA interactives public"
      },
      "dirty": false
    }
  };
...
define('lab.config',['require','common/actual-root'],function (require) {
  ...
  publicAPI = {
  "sharing": true,
  "home": "http://lab.dev.concord.org",
  "homeForSharing": "http://lab.dev.concord.org",
    ...
    function setStrokeColor(i, afterSamplePoint) {
      ...
      switch(i) {
        ...
        case 3:
          ...
          break;
        case 4:
          gctx.strokeStyle = "rgba(255,127,0," + opacity + ")";
          break;
        case 5:
          gctx.strokeStyle = "rgba(255,0,255," + opacity + ")";
          break;
      }
    }
    ...
    function setFillColor(i, afterSamplePoint) {
      ...
      switch(i) {
        ...
        case 2:
          ...
          break;
        case 3:
          gctx.fillStyle = "rgba(0,0,0," + opacity + ")";
          break;
        case 4:
          gctx.fillStyle = "rgba(255,127,0," + opacity + ")";
          break;
        case 5:
          gctx.fillStyle = "rgba(255,0,255," + opacity + ")";
          break;
      }
    }
